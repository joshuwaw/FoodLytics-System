    ...
    <div className="flex h-screen font-sans mesh-dots">
      <aside className={`glass-sidebar flex flex-col transition-all duration-300 relative ${isCollapsed ? "w-20" : "w-72"}`}>
        ...
        <div className={`p-6 border-b border-slate-200/30 flex items-center ${isCollapsed ? "justify-center px-0" : "gap-3"}`}>
          <div className="w-10 h-10 min-w-[40px] bg-gradient-to-br from-orange-500 to-orange-600 rounded-2xl flex items-center justify-center shadow-lg shadow-orange-500/20">
        ...
        <div className="p-4 border-t border-slate-200/30">
          <Link href="/pengurus/profil" className={`flex items-center gap-3 p-3 rounded-2xl hover:bg-slate-100/50 transition-colors cursor-pointer ${isCollapsed ? "justify-center" : ""}`}>
